...
generate-agent-manifest:  ## Generates the Gitlab Agent manifest file for deployment.
...
agent:  ## Deploys the Gitlab Agent manifest file generated by the generate-agent-manifest target.
